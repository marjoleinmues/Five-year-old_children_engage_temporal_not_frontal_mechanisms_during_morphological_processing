...
global CCN;
addpath(genpath('/panfs/accrepfs.vampire/data/booth_lab//Marjolein/Morph_5/scripts')); %This is the code path
spm_path='/panfs/accrepfs.vampire/data/booth_lab/LabCode/typical_data_analysis/spm12_elp'; %This is your spm path
...
root='/panfs/accrepfs.vampire/data/booth_lab/Marjolein/Morph_5';
subjects={'sub-5153'};
...
addpath('/panfs/accrepfs.vampire/data/booth_lab/LabCode/typical_data_analysis/2preprocessing/fmri_preproc_generic_mni'); %This is the code path
