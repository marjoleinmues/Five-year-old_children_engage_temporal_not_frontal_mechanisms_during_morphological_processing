...
function Preproc (subjects)
tic
parpool;
global CCN;

addpath(genpath('/panfs/accrepfs.vampire/data/booth_lab/Marjolein/Morph_5/scripts/preproc')); %This is the code path
spm_path='/panfs/accrepfs.vampire/data/booth_lab/LabCode/typical_data_analysis/spm12'; %This is your spm path
tpm='/panfs/accrepfs.vampire/data/booth_lab/LabCode/typical_data_analysis/templates_cerebroMatic/ELP_ses_5/mw_com_prior_Age_0072.nii'; %This is your template path
%tpm='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/LabCode/typical_data_analysis/spm12/tpm/TPM.nii';
addpath(genpath(spm_path));
root='/panfs/accrepfs.vampire/data/booth_lab/Marjolein/Morph_5'; %This is your project folder
% subjects={'sub-6047'}; %manually put subject numbers say 'sub-5004' 'sub-5009', or leave this empty if you have an excel with data_info.
% data_info=''; %final_sample sheet, the subject column should have sub plus subject number.(e.g. sub-5003)
% if isempty(subjects)
...
output_fig='output_figures_ses-5'; %this will put your output figures into output_figures folder under the specified session
...
try
    %Start to preprocess data from here
        ...
        % Spatial smoothing, it will ass s6 to the files
        fwhm=6;
