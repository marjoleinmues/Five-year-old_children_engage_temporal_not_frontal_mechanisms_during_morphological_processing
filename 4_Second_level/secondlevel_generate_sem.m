...
out_dir='/panfs/accrepfs.vampire/data/booth_lab/Marjolein/Morph_5/secondlevel_sem';
...
data_info='/panfs/accrepfs.vampire/data/booth_lab/Marjolein/Morph_5/Subjects_sem.xlsx'; %In this excel, there should be a column of subjects with the header (subjects). The subjects should all be sub plus numbers (sub-5002).
%if isempty(subjects)
...
val{1} = [14, 19, 12, 17, 14, 12, 18, 17, 19, 18, 7, 12, 10, 15, 12, 11, 13, 19, 14, 10, 13, 10, 15, 15, 16, 17, 13, 19, 15, 12, 14, 14, 13, 9];
name{2} = 'kbit_scaled_score'; %raw score
val{2} = [120, 107, 104, 115, 131, 105, 115, 121, 103, 115, 89, 106, 115, 99, 129, 89, 86, 151, 106, 103, 96, 96, 118, 89, 96, 128, 92, 89, 80, 106, 117, 136, 93, 112];
