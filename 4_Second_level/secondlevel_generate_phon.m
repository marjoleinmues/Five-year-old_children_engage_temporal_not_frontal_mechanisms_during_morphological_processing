...
% Last modified: 06/27/2025 by Marjolein
...
% add path to project folder/where preprocessed data is
...
out_dir='/panfs/accrepfs.vampire/data/booth_lab/Marjolein/Morph_5/secondlevel_phon';
...
data_info='/panfs/accrepfs.vampire/data/booth_lab/Marjolein/Morph_5/Subjects_phon.xlsx'; %In this excel, there should be a column of subjects with the header (subjects). The subjects should all be sub plus numbers (sub-5002).
%if isempty(subjects)
...
val{1} = [12, 13, 14, 12, 12, 18, 14, 17, 9, 11, 19, 11, 15, 12, 15, 12, 11, 18, 11, 10, 12, 12, 11, 11, 11, 14, 12, 11, 9, 13, 9, 12, 15, 15, 11, 13, 10, 11, 11, 11, 10];
name{2} = 'kbit_scaled_score'; %raw score
val{2} = [120, 107, 99, 104, 104, 118, 115, 131, 92, 96, 115, 121, 103, 114, 123, 115, 89, 103, 99, 130, 100, 120, 89, 96, 86, 151, 120, 106, 96, 118, 118, 89, 96, 128, 92, 89, 80, 117, 136, 93, 112];
